...
const SHEET_URL ="https://script.google.com/macros/s/AKfycbxF008hnymUc0ftZblI7EPlR4VqRDtY1itfuOVOLrPHs_AVsIdVu7EQ8zYg9Bc_7l-I/exec";
...
const productData = [
    {
        id: "gym-force",
        name: "Gym Force",
        description: "Gym Force - Sport Fitness",
        price: 0,
        image: "img/logo-gym.jpg"
    },
...
function renderProducts(products) {
    ...
    products.forEach(product => {
        ...
        productElement.innerHTML = `
            ...
            <div class="p-4 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] bg-gray-900 rounded-b-lg">
                  <h3 class="text-md  text-gray-200 text-center"><b>${product.name}</b></h3>
                <p class="text-sm text-orange-200 text-center">${product.description || ''}</p>
